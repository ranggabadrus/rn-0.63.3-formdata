...
export default function CreateProductScreen(props) {
  ...
  return (
    <ImageBackground
      style={{width: '100%', height: '100%', backgroundColor: '#F7F6ED'}}>
      ...
      <View
        ...
        <Image
          source={require('../Sample/img/Vector.png')}
          style={{marginLeft: 10, height: 25, width: 30, marginTop: 7}}
        />
        <Text style={{marginLeft: 110, fontSize: 18, marginTop: 5}}>
          Create Product
        </Text>
        <TouchableOpacity>
          <Image
            source={require('../Sample/img/menu.png')}
            style={{marginLeft: 90, height: 20, width: 20, marginTop: 10}}
          />
        </TouchableOpacity>
      </View>
      ...
      <View style={{height: '92%', backgroundColor: '#FFFFFF'}}>
        ...
        <View style={{height: '61%', marginTop: '2%'}}>
          ...
          <TouchableOpacity onPress={handleCreate} style={styles.buttonSave}>
